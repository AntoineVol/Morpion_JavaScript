...
(function() {
	...
	var Game = function() {
		...
		function stopGame(result){
			...
			if(++hyperpion.roundCount>hyperpion.maxRound && hyperpion.listPlayers[0].score !=hyperpion.listPlayers[0].score){endRound()}
		...
		function refreshScore(){
			var newScore;
			if(hyperpion.roundCount>hyperpion.maxRound && hyperpion.listPlayers[0].score ==hyperpion.listPlayers[0].score){
